...
import { SKILL_IDS } from '@/shared/rules/skill-index'
import type { TormentaPower, TormentaPowerId } from '@/shared/api/catalog-types'
import type { ExpertiseName } from '@/shared/api/expertise-names'
import type { SkillId } from '@/shared/rules/skill-index'
/**
 ...
 */
// `raceWithDeformidade` lê o catálogo de raças, que hoje vem por HTTP — quem
// precisa dela usa `shared/lib/abilities-cache` direto (ALE-109).
