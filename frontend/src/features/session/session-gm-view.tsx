 ...
 * delete — sit in a side rail on wide viewports and stack under the tracker
 * on phones. `myCharacterIds` still scopes any GM-owned combatants for the
 * shared vitals rule, though the GM can edit every combatant.
 */
export function SessionGmView({
  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-4 p-3 sm:p-4 lg:grid-cols-[minmax(0,1fr)_20rem]">
