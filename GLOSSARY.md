...
| **manutenção** | `TurnUpkeep`, `PaySustained` | ~~upkeep~~ (na tela), ~~custo de turno~~ | O 1 PM que cada habilidade **sustentada** cobra de quem ENTRA na vez (p227), e a linha da faixa que diz o que foi pago e o que caiu: *"Velocidade e Oração · −2 PM (58 → 56)"*. É **ação livre**, então não gasta o **turno** — quem sustenta entra na vez com a padrão e a de movimento inteiras. Sem mana, *"a habilidade termina"*: o efeito sai da ficha e a faixa nomeia qual. **Não é o custo de conjurar**, que é pago uma vez, na execução. A ordem de pagamento é da mais antiga para a mais nova, e ela só importa quando o mana não cobre todas — o livro deixa a escolha com o jogador, e quem quiser outra encerra a que preferir, o que também é ação livre. |
