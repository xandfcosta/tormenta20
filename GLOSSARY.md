...
| **tinta** (da casa) | `ink` | `api/piloto_ink_test.go` (ALE-301) — a cor escrita num `.templ` que precisa existir na folha compilada |
| **virada** (de fatia) | `switchover` | `api/piloto_switchover_test.go` (ALE-301) — o guarda de que todo endereço antigo leva ao piloto |
