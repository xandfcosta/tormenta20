  ...
  electivePower(C, 'Especialista em Escola',
    'Escolha uma escola — CD para resistir às suas magias dessa escola +2.',
    {
      ...
      choice: {
        ...
        repeatable: true,
        options: [
          { id: 'abjuracao', name: 'Abjuração' },
          { id: 'adivinhacao', name: 'Adivinhação' },
          { id: 'convocacao', name: 'Convocação' },
          { id: 'encantamento', name: 'Encantamento' },
          { id: 'evocacao', name: 'Evocação' },
          { id: 'ilusao', name: 'Ilusão' },
          { id: 'necromancia', name: 'Necromancia' },
          { id: 'transmutacao', name: 'Transmutação' },
        ],
      },
    }),
