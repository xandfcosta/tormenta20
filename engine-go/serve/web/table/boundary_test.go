...
var permitidos = map[string]bool{
	...
	"t20engine/serve/web/routes":  true, // os endereços que ela cita da campanha (ALE-292)
	"t20engine/serve/web/sheetui": true, // o MESMO painel da ficha, embutido (ALE-275)
