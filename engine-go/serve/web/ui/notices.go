...
// A FRASE QUE TODA CENA PRECISA quando o servidor não conseguiu.
//
...
// extenso.
//
// Ela é do kit e não da Mesa porque a crônica lista o mesmo acervo: duas cópias
// da frase é como duas telas passam a dizer coisas diferentes sobre a mesma
// cena. E o que está escrito aqui não é formatação, é uma DECISÃO — "0 peças"
// descreve mal o que a linha é, e "cena vazia" nomeia o que o mestre está
// procurando quando abre o acervo para limpar.
//
