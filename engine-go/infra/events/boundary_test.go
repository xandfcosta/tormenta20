...
// O VOCABULÁRIO É FOLHA, e este guarda é o que faz isso valer.
//
// `events` está na lista de permitidos dos guardas de fronteira vizinhos, e a
// lista de lá vem com um aviso: *acrescentar o import à lista transforma a porta
// em enfeite*.
//
...
//
// A lista de permitidos daqui é VAZIA porque o vocabulário é de todos e por isso
