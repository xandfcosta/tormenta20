...
// Os guardas do MENU DE CONTEXTO DA PEÇA (ALE-206, em Datastar pela ALE-269).
//
// As mutações têm guarda de estado no `tabuleiro` (`board_state_test.go`). O que
// se prende aqui é a COMPOSIÇÃO — que os verbos existem, que a trava é do
