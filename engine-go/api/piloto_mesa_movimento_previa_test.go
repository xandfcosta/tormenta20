...
// Os guardas da PRÉVIA do arrasto (ALE-203, pedido do dono: *"durante o drag do
// token, mostre a seta apontando para o token movimentando e mostre a distância
// na seta"*).
//
// O que se prende aqui é a COMPOSIÇÃO: que a rota responde em SINAIS, que ela
// mede o caminho inteiro nas três faixas, e — a metade que mais importa — que
