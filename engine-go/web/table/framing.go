...
const (
	quadradoMinimo = 20
	quadradoMaximo = 96
	// Os TRÊS são exportados porque a bancada do hospedeiro prova que a PÁGINA
	// semeia o mesmo número que o código usa — escrever 44 no `data-signals`
	// seria a terceira cópia da mesma escolha, e a que fica para trás é sempre a
	// da página.
	DefaultSquare = 44
	ZoomStep      = 8
)
