 ...
 * compartilhar: as fontes vieram para `serve/web/assets/src` e esta config veio junto.
 *
...
export default defineConfig({
  ...
  // folha pede em `/fonts/…` já vivem embutidas em `serve/web/assets/static/fonts`
  // (ver `FontsHandler`).
  publicDir: false,
  resolve: { alias: { '@': resolve(import.meta.dirname, 'serve/web/assets/src') } },
  build: {
    outDir: resolve(import.meta.dirname, 'serve/web/assets/static'),
    ...
    lib: {
      ...
      entry: {
        scene: resolve(import.meta.dirname, 'serve/web/assets/src/scene.ts'),
        grimorio: resolve(import.meta.dirname, 'serve/web/assets/src/grimorio.ts'),
        ...
        reader: resolve(import.meta.dirname, 'serve/web/assets/src/reader.ts'),
