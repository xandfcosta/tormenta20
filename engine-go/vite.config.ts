 ...
 * compartilhar: as fontes vieram para `serve/api/assets/src` e esta config veio junto.
 *
...
export default defineConfig({
  ...
  // folha pede em `/fonts/…` já vivem embutidas em `serve/api/assets/static/fonts`
  // (ver `FontsHandler`).
  publicDir: false,
  resolve: { alias: { '@': resolve(import.meta.dirname, 'serve/api/assets/src') } },
  build: {
    outDir: resolve(import.meta.dirname, 'serve/api/assets/static'),
    ...
    lib: {
      ...
      entry: {
        scene: resolve(import.meta.dirname, 'serve/api/assets/src/scene.ts'),
        grimorio: resolve(import.meta.dirname, 'serve/api/assets/src/grimorio.ts'),
        ...
        reader: resolve(import.meta.dirname, 'serve/api/assets/src/reader.ts'),
        ...
        table: resolve(import.meta.dirname, 'serve/api/assets/src/table.ts'),
      },
      formats: ['es'],
