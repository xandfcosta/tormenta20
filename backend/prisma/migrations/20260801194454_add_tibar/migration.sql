...
CREATE TABLE "new_Character" (
    ...
    "tibar" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Character" ("charisma", "classChoices", "classPowers", "constitution", "createdAt", "dexterity", "displacement", "god", "godPower", "hpCurrent", "hpMax", "id", "intelligence", "level", "mpCurrent", "mpMax", "name", "origin", "originChoices", "ownerId", "powerChoices", "proficiencies", "raceAbilityChoices", "raceAttributeChoices", "secondaryRaceChoices", "size", "strength", "updatedAt", "wisdom") SELECT "charisma", "classChoices", "classPowers", "constitution", "createdAt", "dexterity", "displacement", "god", "godPower", "hpCurrent", "hpMax", "id", "intelligence", "level", "mpCurrent", "mpMax", "name", "origin", "originChoices", "ownerId", "powerChoices", "proficiencies", "raceAbilityChoices", "raceAttributeChoices", "secondaryRaceChoices", "size", "strength", "updatedAt", "wisdom" FROM "Character";
