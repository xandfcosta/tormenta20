...
Este repositório já vive disso e nunca escreveu a regra: são **69 guardas de
...
coordenada nem deslocamento no caminho. Cada um nasceu de um defeito que tinha
irmãos.
