...
Este repositório já vive disso e nunca escreveu a regra: são **63 guardas de
...
chave de atributo do Datastar carrega caixa alta. Cada um nasceu de um defeito
que tinha irmãos.
