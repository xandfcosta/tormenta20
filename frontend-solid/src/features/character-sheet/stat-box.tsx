  ...
  return (
    <Dialog>
      <DialogTrigger
        ...
        class={cn(
          'relative flex cursor-pointer flex-col items-center rounded-sm border-2 bg-[var(--grimorio-panel)] p-2 text-center outline-none transition-colors focus-visible:ring-2',
          tone().trigger,
        )}
      >
        <span
