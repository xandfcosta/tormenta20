 ...
 *  3. `SituationalSection` — opt-in context modifiers (terrain, target type,
 *     homebrew item toggles). Client state, per character, in localStorage.
 *
 * Power stances (Fúria, Inspiração) are deliberately absent: they are switched
 * on in the Poderes block, which is where their PM cost is charged (ALE-87).
 */
