...
engine-go/ Go: API (:3001), motor de regras, e as CENAS em templ + Datastar —
           com a folha e as ilhas de JS delas em serve/web/assets/src (Tailwind v4)
...
O admin abre e edita **qualquer campanha** (as dos outros aparecem nas Campanhas
...
junto e passa as campanhas dela para você.
...
Variáveis (defaults em `engine-go/infra/config/config.go`):
